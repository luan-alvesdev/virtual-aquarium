...
import { aquarioArray, medidas, pegarDimensoes } from './AquarioFundo'
...
function generateRandomPosition() {
  const width = medidas.largura / 2 // Largura do aquário
  const height = medidas.altura / 2 // Altura do aquário

  // Gerar novos movimentos aleatórios em várias direções
  const moveX1 = Math.random() * 200 - 100 + 'vw' // Movimento 1
  const moveY1 = Math.random() * 200 - 100 + 'vh' // Movimento 1
  const moveX2 = Math.random() * 200 - 100 + 'vw' // Movimento 2
  const moveY2 = Math.random() * 200 - 100 + 'vh' // Movimento 2
  const moveX3 = Math.random() * 200 - 100 + 'vw' // Movimento 3
  const moveY3 = Math.random() * 200 - 100 + 'vh' // Movimento 3
  const moveX4 = Math.random() * 200 - 100 + 'vw' // Movimento 4
  const moveY4 = Math.random() * 200 - 100 + 'vh' // Movimento 4

  return {
    top: height + 'px', // Posição vertical
    left: width + 'px', // Posição horizontal
    animationDuration: `${Math.random() * 15 + 10}s`, // Aleatório entre 10s e 25s (mais lento)
    '--move-x1': moveX1,
    '--move-y1': moveY1,
    '--move-x2': moveX2,
    '--move-y2': moveY2,
